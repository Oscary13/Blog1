...
-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.html" class="logo">Blog-<em>-N.O.R.</em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="#top" class="active">Inicio</a></li>
                            <li class="scroll-to-section"><a href="#features">Acerca de</a></li>
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6>INTEGRANTES</h6>
                <h2>1-<em>V. Daniela Landin Jarquin</em></h2>
                <h2>2-<em>Raul Hernandez Hernandez</em></h2>
                <h2>3-<em>Oscary Basurto Basurto</em></h2>
                <div class="main-button scroll-to-section">
                    <a href="#features">Comenzemos</a>
                </div>
            </div>
        </div>
    </div>
